...
public class AgendaEventos {
	...
	public static void main(String[] args) {
		...
		agendaEventos.adicionarEvento(LocalDate.of(2024, Month.AUGUST, 17), "Evento 4", "Atração 4");
		agendaEventos.adicionarEvento(LocalDate.of(2024, Month.OCTOBER, 21), "Evento 5", "Atração 5");
